    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<EShopDbContext>(option =>
                ...
                .UseSqlServer(Configuration.GetConnectionString("BookStoreAPI"))
            //.UseSqlServer(Configuration.GetConnectionString("BookStoreAPI"))
            );
            ...
            //            )
            //        .UseLazyLoadingProxies()
            //        .UseSqlite(Configuration.GetConnectionString("BookStoreAPI"))
            //);

            // use swagger
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "API BookStore PRO", Version = "v1" });
